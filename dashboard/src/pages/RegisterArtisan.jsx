      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full max-w-md bg-white/90 shadow-2xl p-10 rounded-3xl m-4 backdrop-blur-md border border-black" style={{ boxShadow: '0 8px 32px 0 rgba(0,0,0,0.25)', fontFamily: 'Poppins, Verdana, monospace' }}>
          ...
          <div className="w-full mb-2 relative">
            ...
            <label
              htmlFor="username"
              className={`absolute left-4 transition-all duration-300 pointer-events-none px-1 ${(userData.username || usernameFocused || errors.username) ? 'top-2 text-xs' : 'top-1/2 -translate-y-1/2 text-sm'} ${errors.username ? 'text-red-500 font-bold' : 'text-black'}`}
              style={{ fontFamily: 'Poppins, Verdana, monospace', fontWeight: 400, zIndex: 10 }}
            >
              Enter Username
            </label>
            {errors.username && <p className="text-red-500 text-xs mt-1 font-bold" style={{ fontFamily: 'Poppins, Verdana, monospace' }}>{errors.username}</p>}
          </div>
          {/* Email */}
          <div className="w-full mb-2 relative">
            <input
              ...
              className={`w-full px-4 py-4 text-base text-black border border-black rounded-md focus:outline-none focus:ring-2 focus:ring-black transition-all duration-300 bg-white peer shadow-sm ${errors.email ? 'border-red-500' : ''}`}
              style={{ fontFamily: 'Poppins, Verdana, monospace', fontWeight: 400 }}
              autoComplete="off"
              required
              id="email"
            ...
            <label
              htmlFor="email"
              className={`absolute left-4 transition-all duration-300 pointer-events-none px-1 ${(userData.email || emailFocused || errors.email) ? 'top-2 text-xs' : 'top-1/2 -translate-y-1/2 text-sm'} ${errors.email ? 'text-red-500 font-bold' : 'text-black'}`}
              style={{ fontFamily: 'Poppins, Verdana, monospace', fontWeight: 400, zIndex: 10 }}
            >
              Enter Email
            </label>
            {errors.email && <p className="text-red-500 text-xs mt-1 font-bold" style={{ fontFamily: 'Poppins, Verdana, monospace' }}>{errors.email}</p>}
          </div>
          {/* Phone */}
          <div className="w-full mb-2 relative">
            <input
              ...
              className={`w-full px-4 py-4 text-base text-black border border-black rounded-md focus:outline-none focus:ring-2 focus:ring-black transition-all duration-300 bg-white peer shadow-sm ${errors.phone ? 'border-red-500' : ''}`}
              style={{ fontFamily: 'Poppins, Verdana, monospace', fontWeight: 400 }}
              autoComplete="off"
              required
              id="phone"
            ...
            <label
              htmlFor="phone"
              className={`absolute left-4 transition-all duration-300 pointer-events-none px-1 ${(userData.phone || phoneFocused || errors.phone) ? 'top-2 text-xs' : 'top-1/2 -translate-y-1/2 text-sm'} ${errors.phone ? 'text-red-500 font-bold' : 'text-black'}`}
              style={{ fontFamily: 'Poppins, Verdana, monospace', fontWeight: 400, zIndex: 10 }}
            >
              Enter Phone Number
            </label>
            {errors.phone && <p className="text-red-500 text-xs mt-1 font-bold" style={{ fontFamily: 'Poppins, Verdana, monospace' }}>{errors.phone}</p>}
          </div>
          {/* Password */}
          <div className="w-full mb-2 relative">
            <input
            ...
            <button
              ...
              className={`absolute right-4 transition-all duration-300 text-black hover:text-gray-700 focus:outline-none ${(userData.password || passwordFocused || errors.password) ? 'top-3 translate-y-0' : 'top-1/2 -translate-y-1/2'}`}
              tabIndex={-1}
            ...
            <label
              htmlFor="password"
              className={`absolute left-4 transition-all duration-300 pointer-events-none px-1 ${(userData.password || passwordFocused || errors.password) ? 'top-2 text-xs' : 'top-1/2 -translate-y-1/2 text-sm'} ${errors.password ? 'text-red-500 font-bold' : 'text-black'}`}
              style={{ fontFamily: 'Poppins, Verdana, monospace', fontWeight: 400, zIndex: 10 }}
            >
              Enter Password
            </label>
            {errors.password && <p className="text-red-500 text-xs mt-1 font-bold" style={{ fontFamily: 'Poppins, Verdana, monospace' }}>{errors.password}</p>}
          </div>
          {/* Confirm Password */}
          <div className="w-full mb-2 relative">
            <input
              ...
              className={`w-full px-4 py-4 text-base text-black border border-black rounded-md focus:outline-none focus:ring-2 focus:ring-black transition-all duration-300 bg-white peer shadow-sm ${errors.confirmPassword ? 'border-red-500' : ''}`}
              style={{ fontFamily: 'Poppins, Verdana, monospace', fontWeight: 400, border: 'none', boxShadow: 'none' }}
              autoComplete="off"
              required
              id="confirmPassword"
            ...
            <button
              ...
              className={`absolute right-4 transition-all duration-300 text-black hover:text-gray-700 focus:outline-none ${(userData.confirmPassword || confirmPasswordFocused || errors.confirmPassword) ? 'top-3 translate-y-0' : 'top-1/2 -translate-y-1/2'}`}
              tabIndex={-1}
            ...
            <label
              ...
              className={`absolute left-4 transition-all duration-300 pointer-events-none px-1 ${(userData.confirmPassword || confirmPasswordFocused || errors.confirmPassword) ? 'top-2 text-xs' : 'top-1/2 -translate-y-1/2 text-sm'} ${errors.confirmPassword ? 'text-red-500 font-bold' : 'text-black'}`}
              style={{ fontFamily: 'Poppins, Verdana, monospace', fontWeight: 400, zIndex: 10 }}
            >
              Confirm Password
            </label>
            {errors.confirmPassword && <p className="text-red-500 text-xs mt-1 font-bold" style={{ fontFamily: 'Poppins, Verdana, monospace' }}>{errors.confirmPassword}</p>}
          </div>
          <button
